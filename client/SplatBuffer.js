...
import { Matrix3 } from "./engine/math/Matrix3.js"
...
export class SplatBuffer {
    ...
    getCenter(index, outCenter = new Vector3()) {
        let bucket = [0, 0, 0];
    ...
    getScale(index, outScale = new Vector3()) {
    ...
    getRotation(index, outRotation = new Quaternion()) {
    ...
    getColor(index, outColor = new Vector4()) {
